      ...
      <div className="container mx-auto px-4 py-10">
        ...
        {loading ? (
          <div className="flex flex-col justify-center items-center h-64 bg-white rounded-xl shadow-md p-8">
            ...
            <p className="text-gray-500 mt-4">ルーム情報を取得中...</p>
          </div>
        ) : error ? (
          ...
          <div className="bg-white p-10 rounded-xl shadow-md text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">ルームが見つかりませんでした</h3>
            <p className="mt-2 text-gray-500">検索条件を変更するか、新しいルームを作成してみましょう</p>
            {state.isAuthenticated && state.user?.role === 'performer' && (
              <button
                onClick={handleCreateRoom}
